...
import { decrQuantity, emptyCart, incrQuantity, removeCartItem } from '../redux/slices/cartSlice'
...
const Cart = () => {
  ...
  return (
    <>
      <Header />
      <div style={{ paddingTop: '100px' }} className='container px-20 mx-auto'>
        {
          userCart?.length > 0 ?
            <>
              <h1 className="text-5xl text-blue-800 font-bold">Cart Summary</h1>
              <div className="grid grid-cols-3 gap-4 mt-5">
                      ...
                      <tr key={product?.id}>
                        ...
                        <td>
                          <div className="flex">
                            ...
                            <input style={{ width: '30px' }} readOnly value={product?.quantity} type="text" className='border p-1 rounded ms-2 me-2' />
                            <button  onClick={()=>dispatch(incrQuantity(product))} className="font-bold">+</button>
                ...
                <div className="col-span-1 border rounded shadow p-5">
                  ...
                  <hr />
                  <button onClick={handleCheckout} className="w-full bg-green-600 rounded p-5 text-white font-bold mt-5 text-xl">Check Out</button>
                </div>
              </div>
            </>
            :
            <div className='flex flex-col justify-center items-center'>
              ...
              <h1 style={{ marginTop: '20px' }} className="text-pink-600 font-bold text-3xl my-5">Your Cart is Empty!!!</h1>
            </div>
        }
      </div>
    </>
